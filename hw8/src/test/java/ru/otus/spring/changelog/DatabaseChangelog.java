...
public class DatabaseChangelog {
    ...
    public void insertBook(BookWithCommentsRepository bookRepository) {
        BookWithComments book = new BookWithComments("1", "Book of Ivan 1", ivan, action,
                List.of(new Comment(ObjectId.get().toString(), "Comment 1")));
        bookRepository.save(book);
        BookWithComments book2 = new BookWithComments("2", "Book of Nikolay 1", nikolay, adventure,
                List.of(new Comment(ObjectId.get().toString(), "Comment 1")));
